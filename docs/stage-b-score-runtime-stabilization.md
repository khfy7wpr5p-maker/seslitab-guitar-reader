...
1. The score view uses the reviewed ST Score Rendering Layer revision `8b469b7f40a4dbea9c097cda49a79dff132071cb`, contract `0.2.0`.
...
Stage C note-level hit testing is explicitly out of scope. Any required renderer semantic/interaction contract extension must be reviewed separately before cross-repository changes.
